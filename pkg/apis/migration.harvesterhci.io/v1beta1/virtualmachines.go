...
func (in *VirtualMachineImport) GetDefaultNetworkInterfaceModel() string {
	return pointer.StringDeref(in.Spec.DefaultNetworkInterfaceModel, NetworkInterfaceModelVirtio)
}

func (in *NetworkMapping) GetNetworkInterfaceModel() string {
	return pointer.StringDeref(in.NetworkInterfaceModel, NetworkInterfaceModelVirtio)
}
